...
import com.vlynn.kotlinytmusicscraper.extractor.Extractor
...
import com.vlynn.kotlinytmusicscraper.models.YouTubeClient.Companion.IOS
...
import com.vlynn.kotlinytmusicscraper.models.body.AccountMenuBody
import com.vlynn.kotlinytmusicscraper.models.body.BrowseBody
import com.vlynn.kotlinytmusicscraper.models.body.CreatePlaylistBody
import com.vlynn.kotlinytmusicscraper.models.body.EditPlaylistBody
import com.vlynn.kotlinytmusicscraper.models.body.FormData
import com.vlynn.kotlinytmusicscraper.models.body.GetQueueBody
import com.vlynn.kotlinytmusicscraper.models.body.GetSearchSuggestionsBody
import com.vlynn.kotlinytmusicscraper.models.body.LikeBody
import com.vlynn.kotlinytmusicscraper.models.body.NextBody
import com.vlynn.kotlinytmusicscraper.models.body.PlayerBody
import com.vlynn.kotlinytmusicscraper.models.body.SearchBody
...
import com.vlynn.kotlinytmusicscraper.utils.parseCookieString
import com.vlynn.kotlinytmusicscraper.utils.sha1
import com.vlynn.ktorext.curl.CurlLogger
import com.vlynn.ktorext.encoding.brotli
import com.vlynn.ktorext.getEngine
...
//    --data-raw '["O43z0dpjhgX20SCx4KAo"]'
    ...
    suspend fun getVlynnMusicChart() =
        httpClient.get("https://chart.vlynnmusic.org/api/playlists") {
            accept(ContentType.Application.Json)
            contentType(ContentType.Application.Json)
        }
...
//                    },
    ...
    suspend fun checkForGithubReleaseUpdate() =
        httpClient.get("https://api.github.com/repos/Vlynn01/VlynnMusic/releases/latest") {
            contentType(ContentType.Application.Json)
        }

    suspend fun checkForFdroidUpdate() =
        httpClient.get("https://f-droid.org/api/v1/packages/com.vlynn.music") {
            contentType(ContentType.Application.Json)
        }
    ...
    companion object {
        ...
        // kept in a separate repo (vlynnmusic-files) so the main repo stays credential-free.
        const val TIDAL_REMOTE_CONFIG_URL =
            "https://raw.githubusercontent.com/Vlynn01/VlynnMusic-files/refs/heads/main/remote-config.json"
    }
}
