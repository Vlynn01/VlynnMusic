...
fun Thumbnail.toThumbnail(): com.vlynn.domain.data.model.searchResult.songs.Thumbnail =
    com.vlynn.domain.data.model.searchResult.songs.Thumbnail(
        height = this.height ?: 0,
        url = this.url,
        width = this.width ?: 0,
    )

fun List<Thumbnail>.toListThumbnail(): List<com.vlynn.domain.data.model.searchResult.songs.Thumbnail> {
    val list = mutableListOf<com.vlynn.domain.data.model.searchResult.songs.Thumbnail>()
    this.forEach {
