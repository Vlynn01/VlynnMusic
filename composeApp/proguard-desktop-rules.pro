...
-keep class com.vlynn.domain.data.model.** { *; }
...
-keep class com.vlynn.music.data.model.** { *; }
-keep class com.vlynn.music.extension.AllExtKt { *; }
-keep class com.vlynn.music.extension.AllExtKt$* { *; }
-keep class com.vlynn.kotlinytmusicscraper.extension.MapExtKt$* { *; }
...
-dontwarn com.vlynn.data.di.loader.LoaderKt
-dontwarn com.vlynn.media3.ui.MediaPlayerViewKt
