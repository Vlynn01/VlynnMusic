package com.vlynn.media3.service
...
import com.vlynn.common.MEDIA_NOTIFICATION
...
import com.vlynn.media3.extension.toCommandButton
...
internal class SimpleMediaService :
    MediaLibraryService(),
    KoinComponent {
    private val coroutineScope by inject<CoroutineScope>(named(com.vlynn.common.Config.SERVICE_SCOPE))
