...
object MEDIA_NOTIFICATION {
    ...
    const val NOTIFICATION_CHANNEL_NAME = "VlynnMusic Playback Notification"
    const val NOTIFICATION_CHANNEL_ID = "VlynnMusic Playback Notification ID"
}
