...
import com.vlynn.data.mapping.toCanvasResult
import com.vlynn.data.mapping.toLyrics
...
import com.vlynn.domain.data.model.metadata.VlynnMusicLyrics
...
import com.vlynn.domain.utils.toPlainLrcString
import com.vlynn.domain.utils.toRichSyncLrcString
import com.vlynn.domain.utils.toSyncedLrcString
...
internal class LyricsCanvasRepositoryImpl(
    ...
    private val simpMusicLyrics: VlynnMusicLyricsClient,
    ...
    // VlynnMusic Lyrics
    private val simpMusicLyricsTag = "VlynnMusicLyricsRepository"

    override fun getVlynnMusicLyrics(videoId: String): Flow<Resource<Lyrics>> =
        flow {
            simpMusicLyrics
                .getLyrics(videoId)
                .onSuccess { lyrics ->
    ...
    override fun getVlynnMusicTranslatedLyrics(
        videoId: String,
        language: String,
    ): Flow<Resource<Lyrics>> =
        flow {
    ...
    override fun voteVlynnMusicLyrics(
        lyricsId: String,
        upvote: Boolean,
    ...
    override fun voteVlynnMusicTranslatedLyrics(
    ...
    override fun insertVlynnMusicLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
        duration: Int,
        lyrics: Lyrics,
    ...
    override fun insertVlynnMusicTranslatedLyrics(
        dataStoreManager: DataStoreManager,
        track: Track,
