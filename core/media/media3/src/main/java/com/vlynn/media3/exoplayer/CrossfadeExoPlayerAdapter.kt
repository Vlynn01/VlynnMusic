package com.vlynn.media3.exoplayer
...
import com.vlynn.media3.audio.BiquadFilter
import com.vlynn.media3.audio.CrossfadeFilterAudioProcessor
import com.vlynn.media3.exoplayer.CrossfadeExoPlayerAdapter.Companion.SPEED_PITCH_STEP
 ...
 *
 * Architecture mirrors [com.vlynnmusic.media_jvm.GstreamerPlayerAdapter]:
                        ...
                        if (retryCount < maxRetryCount) {
                            ...
                            coroutineScope.launch {
                                try {
                                    ...
                                    streamRepository.invalidateFormat("${com.vlynn.common.MERGING_DATA_TYPE.VIDEO}$currentVideoId")
