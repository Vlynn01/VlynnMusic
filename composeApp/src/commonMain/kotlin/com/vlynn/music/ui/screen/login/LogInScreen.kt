package com.vlynn.music.ui.screen.login
...
import com.vlynn.music.expect.ui.PlatformWebView
import com.vlynn.music.expect.ui.createWebViewCookieManager
import com.vlynn.music.expect.ui.rememberWebViewState
import com.vlynn.music.ui.component.DevLogInBottomSheet
import com.vlynn.music.ui.component.DevLogInType
...
import vlynnmusic.composeapp.generated.resources.log_in
import vlynnmusic.composeapp.generated.resources.login_failed
import vlynnmusic.composeapp.generated.resources.login_success
    ...
    LaunchedEffect(state) {
        snapshotFlow { state.value }.collect {
            Logger.d(
                ...
                "WebViewState: ${
                    when (it) {
                        is com.vlynn.music.expect.ui.WebViewState.Finished -> "Finished"
                        is com.vlynn.music.expect.ui.WebViewState.Loading -> "Loading ${it.progress}%"
                    }
                }",
            )
        }
