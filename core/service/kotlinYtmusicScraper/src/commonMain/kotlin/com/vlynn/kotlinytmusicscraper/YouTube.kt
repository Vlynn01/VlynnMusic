package com.vlynn.kotlinytmusicscraper

import com.eygraber.uri.toKmpUri
import com.vlynn.kotlinytmusicscraper.YouTube.Companion.DEFAULT_VISITOR_DATA
import com.vlynn.kotlinytmusicscraper.extension.toListFormat
import com.vlynn.kotlinytmusicscraper.models.AccountInfo
import com.vlynn.kotlinytmusicscraper.models.AlbumItem
import com.vlynn.kotlinytmusicscraper.models.Artist
import com.vlynn.kotlinytmusicscraper.models.ArtistItem
import com.vlynn.kotlinytmusicscraper.models.BrowseEndpoint
import com.vlynn.kotlinytmusicscraper.models.GridRenderer
import com.vlynn.kotlinytmusicscraper.models.MediaType
import com.vlynn.kotlinytmusicscraper.models.MusicCarouselShelfRenderer
...
import com.vlynn.kotlinytmusicscraper.models.ReturnYouTubeDislikeResponse
import com.vlynn.kotlinytmusicscraper.models.Run
import com.vlynn.kotlinytmusicscraper.models.SearchSuggestions
import com.vlynn.kotlinytmusicscraper.models.SongInfo
import com.vlynn.kotlinytmusicscraper.models.SongItem
import com.vlynn.kotlinytmusicscraper.models.TidalMetadataResult
import com.vlynn.kotlinytmusicscraper.models.VideoItem
import com.vlynn.kotlinytmusicscraper.models.WatchEndpoint
import com.vlynn.kotlinytmusicscraper.models.YTItemType
import com.vlynn.kotlinytmusicscraper.models.YouTubeClient
import com.vlynn.kotlinytmusicscraper.models.YouTubeClient.Companion.TVHTML5
import com.vlynn.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB
import com.vlynn.kotlinytmusicscraper.models.YouTubeClient.Companion.WEB_REMIX
import com.vlynn.kotlinytmusicscraper.models.YouTubeLocale
import com.vlynn.kotlinytmusicscraper.models.getContinuation
import com.vlynn.kotlinytmusicscraper.models.oddElements
import com.vlynn.kotlinytmusicscraper.models.response.AccountMenuResponse
import com.vlynn.kotlinytmusicscraper.models.response.AccountSwitcherEndpointResponse
import com.vlynn.kotlinytmusicscraper.models.response.AddItemYouTubePlaylistResponse
import com.vlynn.kotlinytmusicscraper.models.response.BrowseResponse
import com.vlynn.kotlinytmusicscraper.models.response.CreatePlaylistResponse
import com.vlynn.kotlinytmusicscraper.models.response.DownloadProgress
import com.vlynn.kotlinytmusicscraper.models.response.GetQueueResponse
import com.vlynn.kotlinytmusicscraper.models.response.GetSearchSuggestionsResponse
import com.vlynn.kotlinytmusicscraper.models.response.LikeStatus
import com.vlynn.kotlinytmusicscraper.models.response.NextAndroidMusicResponse
import com.vlynn.kotlinytmusicscraper.models.response.NextResponse
import com.vlynn.kotlinytmusicscraper.models.response.PipedResponse
import com.vlynn.kotlinytmusicscraper.models.response.PlayerResponse
import com.vlynn.kotlinytmusicscraper.models.response.SearchResponse
import com.vlynn.kotlinytmusicscraper.models.response.VlynnMusicChartResponse
import com.vlynn.kotlinytmusicscraper.models.response.TidalSearchResponse
import com.vlynn.kotlinytmusicscraper.models.response.TidalOAuthResponse
import com.vlynn.kotlinytmusicscraper.models.response.RemoteConfig
import com.vlynn.kotlinytmusicscraper.models.response.toLikeStatus
import com.vlynn.kotlinytmusicscraper.models.response.toListAccountInfo
import com.vlynn.kotlinytmusicscraper.models.vlynnmusic.FdroidResponse
import com.vlynn.kotlinytmusicscraper.models.vlynnmusic.GithubResponse
import com.vlynn.kotlinytmusicscraper.models.sponsorblock.SkipSegments
import com.vlynn.kotlinytmusicscraper.models.youtube.GhostResponse
import com.vlynn.kotlinytmusicscraper.models.youtube.Transcript
import com.vlynn.kotlinytmusicscraper.models.youtube.YouTubeInitialPage
import com.vlynn.kotlinytmusicscraper.models.youtube.tryDecodeText
import com.vlynn.kotlinytmusicscraper.pages.AlbumPage
import com.vlynn.kotlinytmusicscraper.pages.ArtistPage
import com.vlynn.kotlinytmusicscraper.pages.ArtistSection
import com.vlynn.kotlinytmusicscraper.pages.BrowseResult
import com.vlynn.kotlinytmusicscraper.pages.ExplorePage
import com.vlynn.kotlinytmusicscraper.pages.MoodAndGenres
import com.vlynn.kotlinytmusicscraper.pages.NextPage
import com.vlynn.kotlinytmusicscraper.pages.NextResult
import com.vlynn.kotlinytmusicscraper.pages.PlaylistContinuationPage
import com.vlynn.kotlinytmusicscraper.pages.PlaylistPage
import com.vlynn.kotlinytmusicscraper.pages.RelatedPage
import com.vlynn.kotlinytmusicscraper.pages.SearchPage
import com.vlynn.kotlinytmusicscraper.pages.SearchResult
import com.vlynn.kotlinytmusicscraper.pages.SearchSuggestionPage
import com.vlynn.kotlinytmusicscraper.parser.fromPlaylistContinuationToTracks
import com.vlynn.kotlinytmusicscraper.parser.fromPlaylistToTrack
import com.vlynn.kotlinytmusicscraper.parser.fromPlaylistToTrackWithSetVideoId
import com.vlynn.kotlinytmusicscraper.parser.getContinuePlaylistContinuation
import com.vlynn.kotlinytmusicscraper.parser.getPlaylistContinuation
import com.vlynn.kotlinytmusicscraper.parser.getReloadParams
import com.vlynn.kotlinytmusicscraper.parser.getSuggestionSongItems
import com.vlynn.kotlinytmusicscraper.parser.hasReloadParams
 ...
 * This library is from [z-huang/InnerTune] and I just modified it to comply with VlynnMusic
 *
 * Here is the object that can create all request to YouTube Music and Spotify in VlynnMusic
...
class YouTube {
     ...
     * In VlynnMusic, I use this function to parsing Home, Playlist, Album data instead using [album], [playlist], [artist] function
...
//        }
    ...
    suspend fun getVlynnMusicChart() =
        runCatching {
            ytMusic.getVlynnMusicChart().body<VlynnMusicChartResponse>()
        }
