package com.vlynn.music.service.backup
...
import com.vlynn.common.DOWNLOAD_EXOPLAYER_FOLDER
import com.vlynn.common.EXOPLAYER_DB_NAME
...
class AutoBackupWorker(
    ...
    override suspend fun doWork(): Result =
        withContext(Dispatchers.IO) {
            try {
                ...
                // Save to Downloads/VlynnMusic folder
    ...
    private fun saveToDownloads(backupFile: File): Boolean {
        ...
        val fileName = "vlynnmusic_backup_$timestamp.zip"
        ...
        return try {
            val contentValues =
                ContentValues().apply {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        put(MediaStore.Downloads.RELATIVE_PATH, "Download/VlynnMusic")
                    }
                }
            ...
            uri?.let { outputUri ->
                ...
                Logger.i(TAG, "Backup saved to Downloads/VlynnMusic/$fileName")
                true
            } ?: false
        } catch (e: Exception) {
    ...
    private fun cleanupOldBackups(maxFiles: Int) {
        try {
            ...
            val selectionArgs =
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                    arrayOf("Download/VlynnMusic/", "vlynnmusic_backup_%.zip")
                } else {
                    arrayOf("vlynnmusic_backup_%.zip")
                }
            ...
            context.contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    if (name.startsWith("vlynnmusic_backup_") && name.endsWith(".zip")) {
