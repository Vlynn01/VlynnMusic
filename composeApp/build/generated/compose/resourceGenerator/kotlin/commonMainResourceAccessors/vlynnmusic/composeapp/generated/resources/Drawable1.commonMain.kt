...
@delegate:ResourceContentHash(-577_198_271)
internal val Res.drawable.round_speed_24: DrawableResource by lazy {
      DrawableResource("drawable:round_speed_24", setOf(
        ResourceItem(setOf(), "${MD}drawable/round_speed_24.xml", -1, -1),
      ))
    }

@delegate:ResourceContentHash(-1_953_209_340)
internal val Res.drawable.rounded_framelayout: DrawableResource by lazy {
      DrawableResource("drawable:rounded_framelayout", setOf(
        ResourceItem(setOf(), "${MD}drawable/rounded_framelayout.xml", -1, -1),
      ))
    }
...
internal fun _collectCommonMainDrawable1Resources(map: MutableMap<String, DrawableResource>) {
  map.put("round_speed_24", Res.drawable.round_speed_24)
  map.put("rounded_framelayout", Res.drawable.rounded_framelayout)
